...
public:
	...
	void SetBattle(std::unique_ptr<IBattleTurnSelector> turnSelector,
		std::shared_ptr<CIsBattleAble> team1, std::shared_ptr<CIsBattleAble> team2);
...
private:
	...
	std::shared_ptr<CIsBattleAble> m_pPlayer = nullptr;
	std::shared_ptr<CIsBattleAble> m_pMonster = nullptr;
