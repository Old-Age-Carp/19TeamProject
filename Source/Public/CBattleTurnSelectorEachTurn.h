...
{
private:
	vector<shared_ptr<CBattleTeam>> mTeamList;
...
public:
	...
	inline weak_ptr<CBattleTeam> GetCurrentTeam() override
	{
		return mCurrentTeamIndex < 0 ? weak_ptr<CBattleTeam>()
			: weak_ptr(mTeamList[mCurrentTeamIndex]);
	}
	void SetTeams(vector<shared_ptr<CBattleTeam>> teamList) override;
