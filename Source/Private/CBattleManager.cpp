...
//
//	m_pLogger->AddLog(L"Battle started with monster: " + m_Monster.GetName() + L" (HP: " + std::to_wstring(m_Monster.GetHp()) + L", ATK: " + std::to_wstring(m_Monster.GetAtk()) + L")");
//}
//
...
//		return;
//	}
//	m_pLogger->AddLog(L"The monster " + m_Monster.GetName() + L" attacked you! (Your remaining health: " + std::to_wstring(m_pGameObject->getHealth()) + L")");
//}
//
